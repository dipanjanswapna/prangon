    ...
    subCategories: [
      ...
      },
      {
        ...
        skills: [
          ...
          { name: "PHP", logo: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><ellipse cx="12" cy="12" rx="10" ry="7.5"/><path d="M12 2.5c5.523 0 10 3.358 10 7.5s-4.477 7.5-10 7.5S2 16.642 2 12S6.477 2.5 12 2.5ZM13 1.5v19M11 1.5v19"/></g></svg> },
