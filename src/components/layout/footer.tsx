...
export function Footer() {
  ...
  return (
    <footer className="bg-muted text-foreground pt-20 pb-8 overflow-hidden">
      <div className="container mx-auto px-4">
        <motion.div 
            ...
            className="relative bg-gradient-to-r from-primary/80 to-primary rounded-2xl p-8 md:p-12 mb-20 shadow-lg text-primary-foreground"
        >
            ...
            <div className="flex-shrink-0">
              ...
              >
                <Button 
                  ...
                  className="bg-background hover:bg-background/90 text-foreground font-semibold py-3 px-6 rounded-lg text-lg shadow-xl"
                >
