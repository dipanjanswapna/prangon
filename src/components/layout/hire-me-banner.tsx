    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
            ...
            className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] w-full max-w-2xl"
        >
            <div className="bg-gray-800/80 backdrop-blur-lg text-white rounded-lg p-2 shadow-2xl flex items-center gap-4">
